...
type otelEnvConfig struct {
	Endpoint   string `env:"GATEWAY_OTEL_ENDPOINT,required"`
	Namespace  string `env:"GATEWAY_OTEL_NAMESPACE,required"`
	InstanceID string `env:"GATEWAY_OTEL_INSTANCE_ID,required"`
}
