...
func (c *userServiceClient) Register(ctx context.Context, in *UserServiceRegisterRequest, opts ...grpc.CallOption) (*UserServiceRegisterResponse, error) {
...
func (c *userServiceClient) Login(ctx context.Context, in *UserServiceLoginRequest, opts ...grpc.CallOption) (*UserServiceLoginResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedUserServiceServer) Register(context.Context, *UserServiceRegisterRequest) (*UserServiceRegisterResponse, error) {
...
func _UserService_Register_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UserServiceRegisterRequest)
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).Register(ctx, req.(*UserServiceRegisterRequest))
	}
...
func _UserService_Login_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).Login(ctx, req.(*UserServiceLoginRequest))
	}
	return interceptor(ctx, in, info, handler)
}
